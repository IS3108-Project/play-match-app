...
export default function ActivityDetailsCard({
  ...
  /** True when the activity starts within 24 hours — leaving will incur a reliability penalty */
  ...
  const handleLeave = async () => {
    try {
      ...
      if (result.isLateCancellation) {
        toast.warning(
          "You left less than 24 hours before the activity. A late-cancel has been recorded and will affect your reliability score.",
        );
      } else {
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="w-4/5">
                          <Input
                            type={
                              guestContactType === "email" ? "email" : "text"
                            }
                            placeholder={
                              guestContactType === "email"
                                ? "Guest's Email"
                  ...
                  <div className="space-y-2">
                    {isLateCancelRisk && (
                      <p className="text-sm text-destructive text-center font-medium">
                        ⚠️ This activity starts within 24 hours. Leaving now
                        will be recorded as a late cancellation and lower your
                        reliability score.
                      </p>
                    )}
